...
export function BrandBaidu(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-baidu SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        ...
        strokeWidth="2"
        d="M4 9.5a1 1.5 0 1 0 2 0a1 1.5 0 1 0-2 0m10.463 2.096c1.282 1.774 3.476 3.416 3.476 3.416s1.921 1.574.593 3.636C17.204 20.711 13.64 19.8 13.64 19.8s-1.416-.44-3.06-.088c-1.644.356-3.06.22-3.06.22s-2.055-.22-2.47-2.304c-.416-2.084 1.918-3.638 2.102-3.858c.182-.222 1.409-.966 2.284-2.394c.875-1.428 3.337-2.287 5.027.221zM8 4.5a1 1.5 0 1 0 2 0a1 1.5 0 1 0-2 0m6 0a1 1.5 0 1 0 2 0a1 1.5 0 1 0-2 0m4 5a1 1.5 0 1 0 2 0a1 1.5 0 1 0-2 0"
      ></path>
    </svg>
  )
}
...
export function BrandGoogle(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-google SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
export function BrandV2ex(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>V2ex SVG Icon</title>
      <path
        fill="currentColor"
        d="M.671 1.933h13.821a1.34 1.34 0 0 1 .98.425l8.166 8.725a1.34 1.34 0 0 1 0 1.834l-8.166 8.724a1.34 1.34 0 0 1-.98.426H.673A.67.67 0 0 1 0 21.395v-6.878h13.19l2.276-2.28a.336.336 0 0 0 0-.474l-2.276-2.28H0V2.604a.67.67 0 0 1 .671-.671"
      ></path>
    </svg>
  )
}

export function BrandJuejin(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-juejin SVG Icon</title>
      <g
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        ...
        strokeWidth="2"
      >
        <path d="m2 12l10 7.422L22 12"></path>
        <path d="m7 9l5 4l5-4m-6-3l1 .8l1-.8l-1-.8z"></path>
      </g>
    </svg>
  )
}
...
export function BrandGithub(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-github SVG Icon</title>
      <g
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
export function BrandBilibili(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-bilibili SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
export function BrandBing(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-bing SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
export function BrandDouban(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
      <title>Brand-douban SVG Icon</title>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
...
export function BrandGitlab(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}><title>Brand-gitlab SVG Icon</title><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M11.981 21L21 13.708L18.498 3l-3.015 6.497H8.997L5.507 3L3 13.708z"></path></svg>
  )
}

export function BrandSpotify(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}><title>Brand-spotify SVG Icon</title><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"><circle cx="12" cy="12" r="9"></circle><path strokeMiterlimit="10" d="M6.5 9.284c3.633-1.4 7.77-.9 11 1.3m-9.688 1.8c2.725-1 5.752-.7 8.073 1m-7.165 2c2.018-.8 4.239-.5 6.055.7"></path></g></svg>
  )
}

export function BrandSpotifyColorful(props: IconProps) {
  return (
    <svg width="40" height="40" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function BrandX(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}><title>Brand-x SVG Icon</title><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m18 4l-5 6.667M6 20l5-6.667m2-2.666L8.3 4.4a1 1 0 0 0-.8-.4H4l7 9.333m2-2.666L20 20h-3.5a1 1 0 0 1-.8-.4L11 13.333"></path></svg>
  )
}


export function BrandGmail(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}><title>Brand-gmail SVG Icon</title><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M16 20h3a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-3zM5 20h3V4H5a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1M16 4l-4 4l-4-4"></path><path d="m4 6.5l8 7.5l8-7.5"></path></g></svg>
  )
}
...
export function BrandDiscord(props: IconProps) {
  return (
...
export function BrandTwitch(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}><title>Brand-twitch SVG Icon</title><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15.556 11.1V7.5M20 3H4v14.4h4.444V21L12 17.4h4.444L20 13.8zm-8.889 8.1V7.5z"></path></svg>
  )
}